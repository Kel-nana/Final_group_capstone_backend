...
class SpecializationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should create specialization' do
    assert_difference('Specialization.count') do
      post specializations_url,
           params: { specialization: { doctor_id: @specialization.doctor_id,
                                       field_of_specialization: @specialization.field_of_specialization } }, as: :json
    end
  ...
  test 'should update specialization' do
    patch specialization_url(@specialization),
          params: { specialization: { doctor_id: @specialization.doctor_id,
                                      field_of_specialization: @specialization.field_of_specialization } }, as: :json
    assert_response :success
  end
